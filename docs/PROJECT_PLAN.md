...
| M6 | **SCOPED DOWN for 2026-09-06 presentation deadline** (see note below table): ~300-500 synthetic pairs generated from the A10 corpus via a local Ollama model, fast heuristic sanity pass instead of full human curation. Original spec (~2-5k pairs, human-curated) remains the target for the eventual thesis submission. | Fine-tuning dataset |
